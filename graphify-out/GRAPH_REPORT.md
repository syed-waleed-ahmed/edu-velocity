...
- `runMcpStudyPackageAgent()` --calls--> `runSample()`  [INFERRED]
  D:\Masters Automation Engineering\MemorAIz\edu-velocity\src\agents\mcpStudyPackageAgent.ts → D:\Masters Automation Engineering\MemorAIz\edu-velocity\src\lib\evaluation\helloWorldTests.ts
